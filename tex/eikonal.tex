...
\end{equation}
and use Parseval's theorem? Then, $||fu|| = \bs{}$ ... I'm tired and need to think/sleep/think tomorrow. But, I'm hoping that we can let $c\equiv 0$, and incorporate the speed into the constraint relation.
