...
K_a2b2c1_a2b2c2 = promotion_mat_tri(a+2,b+2,c+2,H_a2b2c1,H_a2b2c2,2);

Dx = K_a2b2c1_a2b2c2*((K_a2b1c1_a2b2c1*(K_a1b1c1_a2b1c1*(K_a1bc1_a1b1c1*Dx_a1bc1))));
Dy = K_a2b2c1_a2b2c2*((K_a2b1c1_a2b2c1*(K_a1b1c1_a2b1c1*(K_ab1c1_a1b1c1*Dy_ab1c1))));

cu_abc = V_abc'*UW;
cf_abc = V_abc'*FW;
cf_a2b2c2 = K_a2b2c1_a2b2c2*((K_a2b1c1_a2b2c1*(K_a1b1c1_a2b1c1*(K_a1b1c1*(K_a1b1c*(K_a1bc * cf_abc))))));
%cdxu_a2b2c2 = Dx*cu_abc;
%cdyu_a2b2c2 = Dy*cu_abc;
%cres_a1b1c1 = cdxu_a2b2c2'*cdxu_a2b2c2+cdyu_a2b2c2'*cdyu_a2b2c2-cf_a1b1c1'*cf_a1b1c1;
%disp(abs(cres_a1b1c1));
%dxu = V_a1b1c1*cdxu_a2b2c2;
...
disp((W/2)'*((V_a1b1c1*cf_a2b2c2 - F).*Wa1b1c1))
disp((W/2)'*(((V_a1b1c1*cdxu_a2b2c2).^2 + (V_a1b1c1*cdyu_a2b2c2).^2 - (V_a1b1c1*cf_a2b2c2).^2).*Wa1b1c1))
...
figure(3);
trisurf(T,X,Y,V_a1b1c1*cdxu_a2b2c2);
figure(4);
trisurf(T,X,Y,V_a1b1c1*cdyu_a2b2c2);
...
cf_abc = V_abc'*FW;
cf_a2b2c2 = K_a1b1c1*(K_a1b1c*(K_a1bc * cf_abc));
cu_abc = V_abc'*UW;
