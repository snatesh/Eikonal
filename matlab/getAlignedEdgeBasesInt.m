function [V1_aligned, V2_aligned] = getAlignedEdgeBasesInt(V1, rleg1, sleg1, V2, rleg2, sleg2, P1, P2, edge1, edge2)
...
% Outputs:
%   - V1_aligned, V2_aligned : basis integral evaluations, with matched traversal of [0,1]
    ...
    if err_flip < err_no_flip
        V2_aligned = -V2; % flip sign to account for reverse edge traversal in integral
    else
        V2_aligned = V2;
    end
end
